...
define( 'CHILD_THEME_NAME', 'avanti' );
define( 'CHILD_THEME_URL', 'http://www.seesawdesign.ca' );
...
genesis_register_sidebar( array(
	'id'          => 'after-header',
	'name'        => __( 'After Header', 'parallax' ),
	'description' => __( 'This is the after header widget area.', 'parallax' ),
) );

genesis_register_sidebar( array(
	'id'          => 'testimonials',
	'name'        => __( 'Testimonials', 'parallax' ),
	'description' => __( 'This is the before footer widget area.', 'parallax' ),
) );
